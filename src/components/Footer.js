...
function Footer() {
  return (
<footer class="p-4 bg-[#0D0D2B]  sm:p-6 dark:bg-gray-900">
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="" class="flex items-center">
            <img src='images/Logo.png' alt='.' className='w-[40px] h-[40px]' />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Crappo</span>
            </a>
        </div>
        <div class="grid grid-cols-2 md:gap-1 md:ml-14 md:mr-0 sm:gap-6 sm:grid-cols-3">
            <div>
            ...
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="https://github.com/themesberg/flowbite" class="hover:underline ">Download Whitepaper</a>
                    </li>
                    <li className='mb-4'>
                        <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">Smart Token</a>
                    </li>
                    <li class="mb-4">
                        <a href="https://github.com/themesberg/flowbite" class="hover:underline ">Blockchain Explorer</a>
                    </li>
                    <li class="mb-4">
                        <a href="https://github.com/themesberg/flowbite" class="hover:underline ">Crypto API</a>
                    </li>
                    <li class="mb-4">
                        <a href="https://github.com/themesberg/flowbite" class="hover:underline ">Interest</a>
                    </li>
                </ul>
            </div>
            <div>
            <h3 className='text-[28px] font-[500] leading-[150%] text-white'>We accept following payment systems</h3>
